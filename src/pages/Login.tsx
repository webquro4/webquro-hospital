...
import { PatientProfile } from '@/components/appointment/PatientProfile';
...
export const MultiStepAppointmentModal: React.FC<MultiStepAppointmentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center mt-5 p-4">
      {/* Simple backdrop */}
      <div 
      ...
      {/* Clean modal */}
      <div className="relative w-full max-w-3xl max-h-[90vh] bg-background rounded-2xl shadow-2xl overflow-hidden border flex flex-col mt-200">
        {/* Simple header */}
